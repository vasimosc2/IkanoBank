"""
Calculation Service — REST API layer.

This module is purely a translation layer: it parses HTTP requests,
calls the functions in calculations.py, and serialises the responses.
